...
const PersonnelPage = () => {
  ...
  const [filterStatus, setFilterStatus] = useState<"all" | Personnel["status"]>(
    "all"
  );
  ...
  const stats = useMemo(() => {
    ...
    const avgTenure =
      personnel.reduce((sum, p) => {
        const years =
          (Date.now() - new Date(p.hireDate).getTime()) / (1000 * 60 * 60 * 24 * 365);
        return sum + years;
  ...
  const openAssignModal = () => {
    setAssignSelectedProcs([...(personForm.allowedProcesses ?? [])]);
    setAssignSelectedMach([...(personForm.allowedMachines ?? [])]);
    setAssignProcQuery("");
    setAssignMachQuery("");
    setAssignOpen(true);
  };
  ...
  const saveAssignments = () => {
    ...
    // quick-assign from table (not in edit modal): persist directly
  ...
  const personnelColumns = [
    {
      ...
      render: (person: Personnel) => (
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-br from-sky-500 to-sky-600 rounded-full flex items-center justify-center text-white text-sm font-bold">
            {person.firstName[0]}
            {person.lastName[0]}
          </div>
          <div>
    ...
    },
    {
      ...
      render: (person: Personnel) => (
        <span className="text-sm text-white/70">
          {(person.allowedProcesses?.length ?? 0)} proc •{" "}
          {(person.allowedMachines?.length ?? 0)} mach
        </span>
      ),
    },
    {
      ...
      render: (person: Personnel) => (
        <div className="flex items-center justify-end gap-2">
          <button
            ...
            className="text-sky-300 hover:text-sky-200 p-1 rounded"
            title="Edit"
          >
  ...
  return (
    <div className="text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        {loading ? (
          <div className="rounded-lg border border-white/10 bg-white/5">
            <Loading text="Loading Personnel..." />
          </div>
        ) : (
          <DataTable
            ...
            emptyMessage={
              <EmptyState
                icon={<Users size={48} className="mx-auto text-white/50 mb-4" />}
                title="No Personnel found"
                message="Create your first Personnel to get started"
      ...
      <Modal
        ...
        title={<span>{selectedPerson ? "Edit" : "Add"} Employee</span>}
        size="2xl"
      ...
      >
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPersonForm({ ...personForm, empCode: e.target.value })
                  }
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setPersonForm({ ...personForm, department: e.target.value })
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPersonForm({ ...personForm, position: e.target.value })
                  }
                  className="glass-input w-full focus:border-transparent"
                />
              </div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPersonForm({ ...personForm, hireDate: e.target.value })
                  }
                  className="glass-input w-full focus:border-transparent"
                />
              </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setPersonForm({ ...personForm, calendarId: e.target.value })
                  }
                  className="w-full px-3 py-2 rounded-lg border border-white/20 bg-white/5 text-white focus:ring-2 focus:ring-sky-500/50 focus:border-transparent"
                >
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-white/20 bg-white/5 text-white focus:ring-2 focus:ring-sky-500/50 focus:border-transparent"
                >
                  {["Day Shift", "2-Shift", "3-Shift Rotating", "Part-Time Evening", "Flexible"].map(
                    (s) => (
                      <option key={s} value={s} className="select option">
                        {s}
                      </option>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPersonForm({ ...personForm, workCenter: e.target.value })
                  }
          ...
          {/* Skills & Certifications + Assign button */}
          <div>
      ...
      {/* ===== Modal: Assign Processes/Machines ===== */}
      <Modal
        open={assignOpen}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-white">
              ...
              <div className="max-h-[40vh] overflow-auto space-y-1">
                {filteredProcs.map((p) => {
                  ...
                  return (
                    <label
                      key={p.process_code}
                      className="flex items-center gap-3 px-2 py-2 rounded hover:bg-white/10 cursor-pointer"
                    >
                      <input
                        type="checkbox"
                        checked={checked}
                        onChange={() =>
                          setAssignSelectedProcs((prev) => toggleCode(prev, p.process_code))
                        }
                ...
                {filteredProcs.length === 0 && (
                  <div className="text-sm text-white/60 px-2 py-4">No processes</div>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-white/10 bg-white/5">
            <div className="p-4 border-b border-white/10 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={selectAllMach}
                  className="px-2 py-1 text-xs rounded border border-white/20 hover:bg-white/10"
                >
                  Select All
                </button>
                <button
                  onClick={clearAllMach}
                  className="px-2 py-1 text-xs rounded border border-white/20 hover:bg-white/10"
                >
                  Clear
                </button>
            ...
            <div className="p-4">
              ...
              <div className="max-h-[40vh] overflow-auto space-y-1">
                  ...
                  return (
                    ...
                    >
                      <input
                        ...
                        checked={checked}
                        onChange={() =>
                          setAssignSelectedMach((prev) => toggleCode(prev, m.machineCode))
                        }
                        className="rounded border-white/30 bg-white/10"
                      />
                      <div className="flex-1">
                ...
                {filteredMach.length === 0 && (
                  <div className="text-sm text-white/60 px-2 py-4">No machines</div>
                )}
              </div>
            </div>
          </div>
