...
import {
  ...
  TrendingUp, Package, Clock, X, Save, AlertCircle, CheckCircle,
  Star, CreditCard, FileText, Globe
} from 'lucide-react';
...
const CUSTOMER_TYPES = ['Enterprise', 'SME', 'Startup', 'Government', 'Distributor'];
const INDUSTRIES = ['Automotive', 'Electronics', 'Technology', 'Manufacturing', 'Industrial', 'Consumer Goods', 'Healthcare'];
const PAYMENT_TERMS = ['COD', 'Net 15', 'Net 30', 'Net 45', 'Net 60', 'Net 90'];
const CURRENCIES = ['THB', 'USD', 'EUR', 'JPY', 'CNY'];
const SHIPPING_OPTIONS = ['Economy', 'Standard', 'Express', 'Same Day'];
...
const CustomerMasterData = () => {
  ...
  const [activeTab, setActiveTab] = useState('basic'); // 'basic', 'contact', 'financial', 'stats', 'preferences'
  ...
  const filteredCustomers = customers.filter(customer => {
    const matchesSearch = customer.code.toLowerCase().includes(searchTerm.toLowerCase()) ||
      ...
      customer.contact.contactPerson.toLowerCase().includes(searchTerm.toLowerCase());
  ...
  const handleDelete = (customerCode) => {
    if (confirm(`Are you sure you want to delete customer ${customerCode}?`)) {
      setCustomers(customers.filter(c => c.code !== customerCode));
    }
  };
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {filteredCustomers.map(customer => (
            <div key={customer.code} className="bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              <div className="p-6">
                {/* Header */}
                ...
                <div className="mt-4 pt-4 border-t border-gray-200 flex items-center justify-between text-xs text-gray-500">
                  <div className="flex items-center gap-1">
                    <Calendar size={12} />
                    Last order: {customer.stats.lastOrderDate ? new Date(customer.stats.lastOrderDate).toLocaleDateString() : 'N/A'}
                  </div>
                  <div className="flex items-center gap-1">
                    <CreditCard size={12} />
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setFormData({
                          ...formData,
                          financial: { ...formData.financial, paymentTerms: e.target.value }
                        })}
                        disabled={modalMode === 'view'}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setFormData({
                          ...formData,
                          financial: { ...formData.financial, currency: e.target.value }
                        })}
                        disabled={modalMode === 'view'}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setFormData({
                          ...formData,
                          financial: { ...formData.financial, creditLimit: parseFloat(e.target.value) || 0 }
                        })}
                        disabled={modalMode === 'view'}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                        min="0"
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                      ...
                      <div className="text-3xl font-bold text-indigo-900">{selectedCustomer.stats.onTimeDelivery}%</div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setFormData({
                          ...formData,
                          preferences: { ...formData.preferences, preferredShipping: e.target.value }
                        })}
                        disabled={modalMode === 'view'}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setFormData({
                          ...formData,
                          preferences: { ...formData.preferences, discountPercent: parseFloat(e.target.value) || 0 }
                        })}
                        disabled={modalMode === 'view'}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                        min="0"
